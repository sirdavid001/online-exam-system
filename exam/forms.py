...
DOU_COURSE_CATALOG = (
    ...
    "CSC 413 - Advanced Python Programming",
    "CSC 414 - Enterprise Java Development",
    "CSC 415 - Modern JavaScript and Frontend Frameworks",
    "CSC 416 - Web Development with PHP and Laravel",
    "CSC 417 - C# and .NET Application Development",
    "CSC 418 - Systems Programming with Go and Rust",
